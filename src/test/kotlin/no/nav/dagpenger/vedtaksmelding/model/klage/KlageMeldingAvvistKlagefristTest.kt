...
class KlageMeldingAvvistKlagefristTest {
    private val klageVedtak =
        KlagevedtakMapper(
            vedtakJson = "/json/klage/klagevedtakAvvistKlagefrist.json".readFile(),
        ).vedtak()

    @Test
    fun `Rikige brevblokker for klagemelding med avvisning som gjelder at bruker ikke har overholdt klagefristen`() {
        KlageMelding(
