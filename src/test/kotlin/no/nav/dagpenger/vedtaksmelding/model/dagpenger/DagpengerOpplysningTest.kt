...
class DagpengerOpplysningTest {
    ...
    fun `Opplysninger ved permittering`() {
        ...
        DagpengerOpplysning
            .OppfyllerKravetTilPermittering(behandlingsresultatData)
            .verdi shouldBe
            true

        DagpengerOpplysning
            .AntallPermitteringsuker(behandlingsresultatData)
            .verdi shouldBe
            26
    }
    ...
    fun `Opplysninger ved permittering fisk`() {
        val behandlingsresultatData = BehandlingsresultatData("/json/innvilgelse/innvigelse_permittering_resultat.json".readFile())
        DagpengerOpplysning.OppfyllerKravetTilPermitteringFiskeindustri(behandlingsresultatData) shouldBe
            true
        DagpengerOpplysning
            .AntallPermitteringsukerFisk(behandlingsresultatData)
            .verdi shouldBe
            26
    }
    ...
    fun `AntallStønadsuker blir satt basert på andre opplysninger`() {
        DagpengerOpplysning.AntallStønadsuker.fra(
            setOf<DagpengerOpplysning<*, *>>(
                DagpengerOpplysning.GrunnlagetForVernepliktErHøyereEnnDagpengegrunnlaget(true, listOf(Periode(true, Opprinnelse.NY))),
                DagpengerOpplysning.PeriodeSomGisVedVerneplikt(26, listOf(Periode(26, Opprinnelse.NY))),
                DagpengerOpplysning.AntallStønadsukerSomGisVedOrdinæreDagpenger(104, listOf(Periode(104, Opprinnelse.NY))),
            ),
    ...
    fun `Skal kunne lage alle type opplysninger med verdi`() {
        ...
        DagpengerOpplysning
            .KravTilProsentvisTapAvArbeidstid(behandlingsresultatData)
            .verdi shouldBe
            50.0
        DagpengerOpplysning
            .InntektskravSiste12Måneder(behandlingsresultatData)
            .verdi shouldBe
            186042
        DagpengerOpplysning
            .InntektskravSiste36Måneder(behandlingsresultatData)
            .verdi shouldBe
            372084
        DagpengerOpplysning
            .ArbeidsinntektSiste12Måneder(behandlingsresultatData)
            .verdi shouldBe
            0
        DagpengerOpplysning
            .ArbeidsinntektSiste36Måneder(behandlingsresultatData)
            .verdi shouldBe
            55550
        DagpengerOpplysning
            .AntallGSomGisSomGrunnlagVedVerneplikt(behandlingsresultatData)
            .verdi shouldBe
            3
        DagpengerOpplysning
            .BruktBeregningsregelGrunnlag(behandlingsresultatData)
            .verdi shouldBe
            "Gjennomsnittlig arbeidsinntekt siste 36 måneder"
        DagpengerOpplysning
            .HarBruktBeregningsregelArbeidstidSiste6Måneder(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .HarBruktBeregningsregelArbeidstidSiste12Måneder(behandlingsresultatData)
            .verdi shouldBe
            false
        DagpengerOpplysning
            .HarBruktBeregningsregelArbeidstidSiste36Måneder(behandlingsresultatData)
            .verdi shouldBe
            false
        DagpengerOpplysning
            .UtbetaltArbeidsinntektPeriode1(behandlingsresultatData)
            .verdi shouldBe
            0
        DagpengerOpplysning
            .UtbetaltArbeidsinntektPeriode2(behandlingsresultatData)
            .verdi shouldBe
            5555
        DagpengerOpplysning
            .UtbetaltArbeidsinntektPeriode3(behandlingsresultatData)
            .verdi shouldBe
            49995
        DagpengerOpplysning
            .AntallStønadsukerSomGisVedOrdinæreDagpenger(behandlingsresultatData)
            .verdi shouldBe
            0
        DagpengerOpplysning
        ...
        DagpengerOpplysning
            .AntallBarnSomGirRettTilBarnetillegg(behandlingsresultatData)
            .verdi shouldBe
            1
        DagpengerOpplysning
            .BarnetilleggIKroner(behandlingsresultatData)
            .verdi shouldBe
            37
        DagpengerOpplysning
            .FørsteMånedAvOpptjeningsperiode(behandlingsresultatData)
            .also {
        ...
        DagpengerOpplysning
            .SisteMånedAvOpptjeningsperiode(behandlingsresultatData)
            .also {
        ...
        DagpengerOpplysning
            .GrunnlagetForVernepliktErHøyereEnnDagpengegrunnlaget(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .SeksGangerGrunnbeløp(behandlingsresultatData)
            .verdi shouldBe
            744168
        DagpengerOpplysning.Aldersgrense(behandlingsresultatData).verdi shouldBe
            67
        DagpengerOpplysning.Grunnlag(behandlingsresultatData).verdi shouldBe
            372084
        DagpengerOpplysning
            .DagsatsMedBarnetilleggEtterSamordningOg90ProsentRegel(behandlingsresultatData)
            .verdi shouldBe
            930
        DagpengerOpplysning.Virkningsdato(behandlingsresultatData).verdi shouldBe LocalDate.of(2025, 1, 29)
        DagpengerOpplysning
            .FastsattVanligArbeidstidPerUke(behandlingsresultatData)
            .verdi shouldBe
            37.5
        DagpengerOpplysning
            .FastsattNyArbeidstidPerUke(behandlingsresultatData)
            .verdi shouldBe
            0
        DagpengerOpplysning.HarSamordnet(behandlingsresultatData).verdi shouldBe
            false
        DagpengerOpplysning
            .SykepengerDagsats(behandlingsresultatData)
            .verdi shouldBe
            0
        DagpengerOpplysning
            .PleiepengerDagsats(behandlingsresultatData)
            .verdi shouldBe
            0
        DagpengerOpplysning
            .OmsorgspengerDagsats(behandlingsresultatData)
            .verdi shouldBe
            0
        DagpengerOpplysning
            .OpplæringspengerDagsats(behandlingsresultatData)
            .verdi shouldBe
            0
        DagpengerOpplysning.UføreDagsats(behandlingsresultatData).verdi shouldBe 0
        DagpengerOpplysning
            .ForeldrepengerDagsats(behandlingsresultatData)
            .verdi shouldBe
            0
        DagpengerOpplysning
            .SvangerskapspengerDagsats(behandlingsresultatData)
            .verdi shouldBe
            0
        DagpengerOpplysning
            .OppfyllerKravTilMinsteinntekt(behandlingsresultatData)
            .verdi shouldBe
            false
        DagpengerOpplysning
            .PeriodeSomGisVedVerneplikt(behandlingsresultatData)
            .verdi shouldBe
            26
        DagpengerOpplysning.Egenandel(behandlingsresultatData).verdi shouldBe 2790
        DagpengerOpplysning
            .KravTilArbeidssøker(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .OppfyllerKravTilMobilitet(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .OppfyllerKravTilArbeidsfør(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .OppfyllerKravTilArbeidssøker(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .OppfyllerKravetTilEthvertArbeid(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .OppyllerKravTilRegistrertArbeidssøker(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .OppfyllerKravetTilIkkeUtestengt(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .OppfyllerKravetTilOpphold(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .IkkeFulleYtelser(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .KravTilTapAvArbeidsinntektOgArbeidstid(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .OppfyllerVilkåretOmTapAvArbeidstid(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .KravTilTapAvArbeidsinntekt(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .IkkeStreikEllerLockout(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning.KravTilAlder(behandlingsresultatData).verdi shouldBe
            true
        DagpengerOpplysning
            .KravTilUtdanning(behandlingsresultatData)
            .verdi shouldBe
            true
        DagpengerOpplysning
            .OppfyllerMedlemskap(behandlingsresultatData)
            .verdi shouldBe
            true
    }
}
