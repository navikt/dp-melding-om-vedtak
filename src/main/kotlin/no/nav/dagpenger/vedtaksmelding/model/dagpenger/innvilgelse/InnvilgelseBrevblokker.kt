...
enum class InnvilgelseBrevblokker(
    ...
    INNVILGELSE_SANKSJON_DEL_1(brevblokkId = "brev.blokk.innvilgelse-sanksjon-del-1"),
    INNVILGELSE_SANKSJON_DEL_2(brevblokkId = "brev.blokk.innvilgelse-sanksjon-del-2"),
    ...
    INNVILGELSE_DAGPENGEPERIODE_HVIS_TOM_DATO_DEL_1(brevblokkId = "brev.blokk.hvor-lenge-kan-du-faa-dagpenger-ny-rett-hvis-tom-dato-del-1"),
    INNVILGELSE_DAGPENGEPERIODE_HVIS_TOM_DATO_DEL_2(brevblokkId = "brev.blokk.hvor-lenge-kan-du-faa-dagpenger-ny-rett-hvis-tom-dato-del-2"),
    INNVILGELSE_DAGPENGEPERIODE_HVIS_TOM_DATO_DEL_3(brevblokkId = "brev.blokk.hvor-lenge-kan-du-faa-dagpenger-ny-rett-hvis-tom-dato-del-3"),
