...
enum class InnvilgelseBrevblokker(
    ...
    INNVILGELSE_ORDINÆR(brevblokkId = "brev.blokk.innvilgelse-ordinaer-fom-tom"),
    INNVILGELSE_DAGSATS_TABELL(brevblokkId = "brev.blokk.innvilgelse-dagsats-tabell"),
    ...
    INNVILGELSE_SLIK_HAR_VI_BEREGNET_DAGPENGENE_DINE(brevblokkId = "brev.blokk.slik-har-vi-beregnet-dagpengene-dine-overskrift"),
    ...
    INNVILGELSE_SAMORDNET_SYKEPENGER(brevblokkId = "brev.blokk.samordnet-sykepenger"),
    INNVILGELSE_SAMORDNET_PLEIEPENGER(brevblokkId = "brev.blokk.samordnet-pleiepenger"),
    INNVILGELSE_SAMORDNET_OMSORGSPENGER("brev.blokk.samordnet-omsorgspenger"),
    INNVILGELSE_SAMORDNET_OPPLÆRINGSPENGER("brev.blokk.samordnet-opplaeringpenger"),
    INNVILGELSE_SAMORDNET_UFØRE("brev.blokk.samordnet-ufore"),
    INNVILGELSE_SAMORDNET_FORELDREPENGER(brevblokkId = "brev.blokk.samordnet-foreldrepenger"),
    INNVILGELSE_SAMORDNET_SVANGERSKAPSPENGER("brev.blokk.samordnet-svangerskapspenger"),
